        ...
        <div className="container-custom relative z-10 w-full mt-20">
          <div className="max-w-3xl border-l-8 border-brand-600 pl-6 md:pl-10 py-2">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-2xl font-medium leading-relaxed">
              Soluções completas em implementos rodoviários. Manutenção especializada, peças genuínas e a garantia de qualidade autorizada.
            </p>
        ...
        <div className="container-custom">
           ...
           <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="group relative overflow-hidden bg-slate-900 text-white aspect-[4/5] shadow-xl">
                 <img src="https://images.unsplash.com/photo-1590496794008-383c8070b257?q=80&w=2071&auto=format&fit=crop" alt="Manutenção" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-30 transition-opacity duration-700 group-hover:scale-105" />
                 ...
                 <div className="absolute bottom-0 left-0 p-8 w-full">
                    ...
                    <p className="text-slate-300 text-sm font-medium opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                      Revisões preventivas e reparos corretivos em suspensões, freios e eixos com rigor técnico.
                    </p>
                 </div>
              </div>
              ...
              {/* Card 2 */}
              <div className="group relative overflow-hidden bg-slate-900 text-white aspect-[4/5] shadow-xl">
                 <img src="https://images.unsplash.com/photo-1621905252507-b35492cc74b4?q=80&w=2069&auto=format&fit=crop" alt="Sistemas Hidráulicos" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-30 transition-opacity duration-700 group-hover:scale-105" />
                 <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/50 to-transparent"></div>
                 <div className="absolute top-6 right-6 w-12 h-12 bg-brand-600 flex items-center justify-center">
                 ...
                 <div className="absolute bottom-0 left-0 p-8 w-full">
                    ...
                    <p className="text-slate-300 text-sm font-medium opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                      Instalação de kits completos, bombas, cilindros e tomadas de força originais.
                    </p>
                 </div>
              </div>
              ...
              <div className="group relative overflow-hidden bg-slate-900 text-white aspect-[4/5] shadow-xl">
                 ...
                 <div className="absolute bottom-0 left-0 p-8 w-full">
                    ...
                    <p className="text-slate-300 text-sm font-medium opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                      Reforço estrutural e solda MIG/MAG para garantir a integridade da sua caçamba.
                    </p>
                 </div>
              </div>
           </div>
        ...
        <div className="container-custom">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 relative">
              ...
              <img src="https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=2070&auto=format&fit=crop" alt="Qualidade Rodoeixo" className="relative z-10 w-full h-[500px] object-cover shadow-2xl grayscale hover:grayscale-0 transition-all duration-700" />
            </div>
            <div className="lg:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-8 mb-10 border-t border-b border-slate-100 py-8">
                <div>
                  <span className="block text-5xl font-black text-brand-600 mb-2">10+</span>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-2/3">
               <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tight mb-6 leading-tight">
                 Assistência Técnica <br />Autorizada
               </h2>
               <p className="text-xl mb-8 font-medium text-brand-50 max-w-2xl leading-relaxed">
                 Temos o orgulho de ser uma assistência credenciada Rossetti. Isso significa acesso exclusivo a peças originais, processos certificados pela fábrica e garantia irrestrita de qualidade no serviço.
               </p>
